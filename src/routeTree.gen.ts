...
import { Route as ApiCaptureTmpEncryptionCheckRouteImport } from './routes/api.capture.tmp-encryption-check'
...
const ApiCaptureTmpEncryptionCheckRoute =
  ApiCaptureTmpEncryptionCheckRouteImport.update({
    id: '/api/capture/tmp-encryption-check',
    path: '/api/capture/tmp-encryption-check',
    getParentRoute: () => rootRouteImport,
  } as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/capture/tmp-encryption-check': typeof ApiCaptureTmpEncryptionCheckRoute
...
export interface FileRouteTypes {
  ...
  fullPaths:
    ...
    | '/api/capture/tmp-encryption-check'
...
export interface RootRouteChildren {
  ...
  ApiCaptureTmpEncryptionCheckRoute: typeof ApiCaptureTmpEncryptionCheckRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/capture/tmp-encryption-check': {
      id: '/api/capture/tmp-encryption-check'
      path: '/api/capture/tmp-encryption-check'
      fullPath: '/api/capture/tmp-encryption-check'
      preLoaderRoute: typeof ApiCaptureTmpEncryptionCheckRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/capture/report-download': {
      id: '/api/capture/report-download'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiCaptureTmpEncryptionCheckRoute: ApiCaptureTmpEncryptionCheckRoute,
}
