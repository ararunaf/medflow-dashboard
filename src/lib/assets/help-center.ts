...
export const HELP_CENTER_ASSETS = {
  ...
  presentation: {
    ...
    pptxPath: "/help/medicflow-ai-corporativo-premium.pptx",
    pdfPath: "/help/medicflow-ai-corporativo-premium.pdf",
    slideCount: 20,
    description:
      "Apresentação executiva do MedicFlow-AI contendo visão geral da plataforma, módulos, benefícios, IA operacional, arquitetura, implantação e roadmap.",
  },
} as const;
