/**
 * Bridge Captura → Enterprise Runtime (ARCH-01 / DIP-02 / DIP-03 / DIP-04 / DIP-05).
 *
 ...
 * NÃO altera OCR/classificação/storage reais do produto, parser, auditoria, UI, APIs ou regras.
