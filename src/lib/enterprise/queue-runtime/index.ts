 ...
 * TISS-RUNTIME-05A: capability Audit — Job PERSISTED → Worker → Audit → Job AUDITED (sem Completed).
 * TISS-RUNTIME-05B: capability Completed — Job AUDITED → Worker → Completed → Job COMPLETED (terminal).
