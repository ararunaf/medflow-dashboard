...
/** TISS-CONV-01 — interpretação estrutural de autorização prévia via Catalog. */
export const BASE_PROCEDURE_AUTHORIZATION_PACK_CODE = "base-procedure-authorization-pack";
...
export const ENTERPRISE_BASE_RULE_PACKS: readonly CanonicalRulePack[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      {
        kind: "canonical-rule",
        id: "rule-guide-honorario-exists",
        code: "BASE-GUIDE-HONORARIO-EXISTS",
        name: "Guide type honorario exists",
        status: "enabled",
        priority: 80,
        severity: "info",
        tags: ["guide-type", "existence", "tiss-conv-01"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-guide-honorario",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "guide-type",
            catalogCode: "guia-honorario",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-guide-honorario-ok",
            actionType: "emit-finding",
            message: "Canonical guide-type guia-honorario resolved via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
  ...
  {
    kind: "canonical-rule-pack",
    packId: "pack-base-procedure-authorization",
    code: BASE_PROCEDURE_AUTHORIZATION_PACK_CODE,
    name: "Base Procedure Authorization Pack",
    description:
      "Interpreta procedimentos TUSS que exigem autorização prévia exclusivamente via TISSCatalogPort (TISS-CONV-01).",
    status: "active",
    version: "1.0.0",
    priority: 850,
    categories: ["authorization", "procedure", "base"],
    tags: ["base", "tiss-conv-01", "procedure", "authorization"],
    compatibleTissVersionCodes: ["tiss-4.01.00", "tiss-3.05.00"],
    metadata: {
      kind: "canonical-rule-pack-metadata",
      namespace: "enterprise.tiss.rule-packs.base",
      channel: "foundation",
      source: "tiss-conv-01",
      tags: ["base", "authorization", "procedure"],
      customAttributes: { packSet: "enterprise-base", knowledgeSource: "TISSCatalogPort" },
    },
    expectedResult: {
      kind: "canonical-rule-pack-expected-result",
    ...
    rules: [
      {
        kind: "canonical-rule",
        id: "rule-auth-40101010",
        code: "BASE-AUTH-PROC-40101010",
        name: "Procedure 40101010 requires authorization",
        status: "enabled",
        priority: 100,
        severity: "info",
        tags: ["authorization", "procedure"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-auth-40101010",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "procedure-type",
            catalogCode: "40101010",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-auth-40101010",
            actionType: "record-attribute",
            attributeKey: "requiresAuthorization",
            attributeValue: true,
            message: "Procedure 40101010 marked requiresAuthorization via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
      {
        kind: "canonical-rule",
        id: "rule-auth-40101028",
        code: "BASE-AUTH-PROC-40101028",
        name: "Procedure 40101028 requires authorization",
        status: "enabled",
        priority: 95,
        severity: "info",
        tags: ["authorization", "procedure"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-auth-40101028",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "procedure-type",
            catalogCode: "40101028",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-auth-40101028",
            actionType: "record-attribute",
            attributeKey: "requiresAuthorization",
            attributeValue: true,
            message: "Procedure 40101028 marked requiresAuthorization via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
      {
        kind: "canonical-rule",
        id: "rule-auth-40801063",
        code: "BASE-AUTH-PROC-40801063",
        name: "Procedure 40801063 requires authorization",
        status: "enabled",
        priority: 90,
        severity: "info",
        tags: ["authorization", "procedure"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-auth-40801063",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "procedure-type",
            catalogCode: "40801063",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-auth-40801063",
            actionType: "record-attribute",
            attributeKey: "requiresAuthorization",
            attributeValue: true,
            message: "Procedure 40801063 marked requiresAuthorization via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
      {
        kind: "canonical-rule",
        id: "rule-auth-40901017",
        code: "BASE-AUTH-PROC-40901017",
        name: "Procedure 40901017 requires authorization",
        status: "enabled",
        priority: 85,
        severity: "info",
        tags: ["authorization", "procedure"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-auth-40901017",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "procedure-type",
            catalogCode: "40901017",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-auth-40901017",
            actionType: "record-attribute",
            attributeKey: "requiresAuthorization",
            attributeValue: true,
            message: "Procedure 40901017 marked requiresAuthorization via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
      {
        kind: "canonical-rule",
        id: "rule-auth-31001016",
        code: "BASE-AUTH-PROC-31001016",
        name: "Procedure 31001016 requires authorization",
        status: "enabled",
        priority: 80,
        severity: "info",
        tags: ["authorization", "procedure"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-auth-31001016",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "procedure-type",
            catalogCode: "31001016",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-auth-31001016",
            actionType: "record-attribute",
            attributeKey: "requiresAuthorization",
            attributeValue: true,
            message: "Procedure 31001016 marked requiresAuthorization via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
      {
        kind: "canonical-rule",
        id: "rule-auth-31001024",
        code: "BASE-AUTH-PROC-31001024",
        name: "Procedure 31001024 requires authorization",
        status: "enabled",
        priority: 75,
        severity: "info",
        tags: ["authorization", "procedure"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-auth-31001024",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "procedure-type",
            catalogCode: "31001024",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-auth-31001024",
            actionType: "record-attribute",
            attributeKey: "requiresAuthorization",
            attributeValue: true,
            message: "Procedure 31001024 marked requiresAuthorization via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
      {
        kind: "canonical-rule",
        id: "rule-auth-30101018",
        code: "BASE-AUTH-PROC-30101018",
        name: "Procedure 30101018 requires authorization",
        status: "enabled",
        priority: 70,
        severity: "info",
        tags: ["authorization", "procedure"],
        conditions: [
          {
            kind: "canonical-rule-condition",
            id: "cond-auth-30101018",
            conditionType: "catalog-entry-exists",
            catalogEntryKind: "procedure-type",
            catalogCode: "30101018",
          },
        ],
        actions: [
          {
            kind: "canonical-rule-action",
            id: "act-auth-30101018",
            actionType: "record-attribute",
            attributeKey: "requiresAuthorization",
            attributeValue: true,
            message: "Procedure 30101018 marked requiresAuthorization via TISSCatalogPort.",
            severity: "info",
          },
        ],
      },
