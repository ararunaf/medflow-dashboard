...
| **S3-01** | Authorization & Access Control Discovery — mapear arquitetura de autorização e controle de acesso sem implementação | 🔮 Discovery |
