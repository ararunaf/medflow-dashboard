...
## 10. Aplicação na Sprint D-06R

| Item                                     | Valor                                                                                                                  |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Sprint de entrega                        | D-06 — Enterprise XML Business Validation Runtime — Business Rules Validation                                          |
| Sprint de gate                           | D-06R — XML Business Validation Release Certification                                                                  |
| Capacidade certificada                   | Business Validation (`businessValidationImplemented = true`)                                                           |
...
## 10. Aplicação na Sprint D-11R

| Item                                     | Valor                                                                                       |
| ---------------------------------------- | ------------------------------------------------------------------------------------------- |
| Sprint de entrega                        | D-11 — Enterprise XML Validation Runtime — Generic XML Validation                           |
| Sprint de gate                           | D-11R — Generic XML Validation Release Certification                                        |
| Capacidade certificada                   | Generic XML Validation (`xmlValidationImplemented = true`)                                  |
