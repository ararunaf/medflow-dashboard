...
| 9 | **TISS-RUNTIME-04B** | Ativar Persistência operacional no Worker (consumo de `PROTOCOL_SENT`) | ⏳ Próxima |
| 10 | TISS-RUNTIME-02+ | Auditoria (uma capability por Sprint) | ⏳ Planejada |
