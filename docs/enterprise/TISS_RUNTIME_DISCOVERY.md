...
| 8 | **TISS-RUNTIME-04A** | Ativar Protocolo operacional no Worker (consumo de `BATCH_CREATED`) | ⏳ Próxima |
| 9 | TISS-RUNTIME-02+ | Persistência → Auditoria (uma capability por Sprint) | ⏳ Planejada |
