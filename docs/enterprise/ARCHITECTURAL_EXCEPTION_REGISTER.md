...
| AER-GA03-A1 | Dual-path Captura (estrutural vs funcional) | GATE-ARCH-03 | Architecture | Alta | Não bloqueante | Aceita (eliminação iniciada em EPC-24A) | EPC-24B…E (cutover em EPC-24E) |
...
#### Alta
- **AER-GA03-A1** Dual-path Captura — **Aceita** — eliminação **iniciada** em EPC-24A (binding `getEnterpriseRuntime`; cutover **não** executado; permanece parcial até EPC-24E) 
