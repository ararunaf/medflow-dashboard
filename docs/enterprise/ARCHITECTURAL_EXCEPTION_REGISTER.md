...
| AER-GA03-A1 | Dual-path Captura (estrutural vs funcional) | GATE-ARCH-03 | Architecture | Alta | Não bloqueante | Aceita (reduzido em EPC-24B; cutover pendente) | EPC-24C…E (cutover em EPC-24E) |
...
#### Alta
- **AER-GA03-A1** Dual-path Captura — **Aceita** — eliminação **iniciada** em EPC-24A; **reduzida** em EPC-24B (Intake awaited + Parser via Extraction Runtime; fallback legado permanece; cutover **não** executado; permanece parcial até EPC-24E) 
