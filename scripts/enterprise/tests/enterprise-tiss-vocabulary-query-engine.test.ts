...
describe("EPC-20D EnterpriseTissVocabularyQueryEngine", () => {
  ...
  const engine = new EnterpriseTissVocabularyQueryEngine(
    registry,
    canonical,
    discovery,
    tiss,
  ...
  it("constrói engine com as sete engines Enterprise", () => {
  ...
  it("getCapabilities ativa discovery, canonical, registry e query, mantem demais false", () => {
