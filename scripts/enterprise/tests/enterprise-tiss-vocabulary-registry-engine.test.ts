...
describe("EPC-20C EnterpriseTissVocabularyRegistryEngine", () => {
  ...
  const engine = new EnterpriseTissVocabularyRegistryEngine(
    canonical,
    discovery,
    tiss,
    tissIntegration,
  ...
  it("constrói engine com as seis engines Enterprise", () => {
  ...
  it("contém apenas seis propriedades readonly, construtor e getCapabilities", () => {
