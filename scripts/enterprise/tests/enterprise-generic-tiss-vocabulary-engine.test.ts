...
describe("EPC-20E EnterpriseGenericTissVocabularyEngine", () => {
  ...
  const canonical = new EnterpriseTissVocabularyCanonicalEngine(
    discovery,
    tiss,
    tissIntegration,
    workflow,
  ...
  const registry = new EnterpriseTissVocabularyRegistryEngine(
    canonical,
    discovery,
    tiss,
    tissIntegration,
  ...
  const query = new EnterpriseTissVocabularyQueryEngine(
    registry,
    canonical,
    discovery,
    tiss,
  ...
  const engine = new EnterpriseGenericTissVocabularyEngine(
    query,
    registry,
    canonical,
    discovery,
  ...
  it("constroi engine com as oito engines Enterprise", () => {
  ...
  it("getCapabilities ativa discovery, canonical, registry, query e generic, mantem demais false", () => {
    ...
    assert.strictEqual(caps.tissVocabularyRegistryImplemented, true);
    assert.strictEqual(caps.tissVocabularyQueryEngineImplemented, true);
    assert.strictEqual(caps.tissGenericVocabularyEngineImplemented, true);
  });
