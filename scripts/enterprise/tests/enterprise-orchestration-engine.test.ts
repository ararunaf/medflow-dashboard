...
describe("J-02 EnterpriseOrchestrationEngine", () => {
  ...
  const engine = new EnterpriseOrchestrationEngine(
    command,
    business,
    integration,
    tiss,
  ...
  it("constrói engine com EnterpriseCommandEngine e fachadas E, F, G, H e I", () => {
  ...
  it("getCapabilities retorna enterpriseCommandImplemented e enterpriseOrchestrationImplemented = true", () => {
